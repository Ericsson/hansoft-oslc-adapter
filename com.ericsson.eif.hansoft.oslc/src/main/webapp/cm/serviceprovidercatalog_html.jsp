...
<html>
	<head>
		...
		<title>Hansoft OSLC Adapter: Service Provider Catalog</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="0" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							Hansoft OSLC Adapter: Service Provider Catalog
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<% for (ServiceProviderRef s : catalog.getServiceProviderReferences()) { %>
