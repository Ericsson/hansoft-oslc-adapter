...
@OslcSchema({
        ...
        @OslcNamespaceDefinition(prefix = Constants.HANSOFT_NAMESPACE_PREFIX, namespaceURI = Constants.HANSOFT_NAMESPACE),
        @OslcNamespaceDefinition(prefix = Constants.HANSOFT_NAMESPACE_PREFIX_EXT, namespaceURI = Constants.HANSOFT_NAMESPACE_EXT),
